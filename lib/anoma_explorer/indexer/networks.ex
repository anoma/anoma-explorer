defmodule AnomaExplorer.Indexer.Networks do
  ...
  @chain_info %{
    ...
    420 => %{name: "Optimism Goerli", short: "OP Goerli", explorer: "https://goerli-optimism.etherscan.io"},
    ...
    80001 => %{name: "Polygon Mumbai", short: "Mumbai", explorer: "https://mumbai.polygonscan.com"},
    ...
    421613 => %{name: "Arbitrum Goerli", short: "Arb Goerli", explorer: "https://goerli.arbiscan.io"},
    421614 => %{name: "Arbitrum Sepolia", short: "Arb Sep", explorer: "https://sepolia.arbiscan.io"},
    534352 => %{name: "Scroll", short: "Scroll", explorer: "https://scrollscan.com"},
    11155111 => %{name: "Sepolia", short: "Sepolia", explorer: "https://sepolia.etherscan.io"},
    11155420 => %{name: "Optimism Sepolia", short: "OP Sep", explorer: "https://sepolia-optimism.etherscan.io"}
  }
